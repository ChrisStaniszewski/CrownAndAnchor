...
@DisplayName("Testing the DoubleOrNothing class methods")
class DoubleOrNothingTest {
 ...
 final void testOrdinary1(int val) {
		...
		assertThrows(IllegalArgumentException.class,() -> new DoubleOrNothing("Crown",val));
	}
 ...
 final void testWorkOutWinnings(int index) {
        DoubleOrNothing oBet=new DoubleOrNothing(CADice.SYMBOLS[index],2);
        ...
        assertEquals(10,oBet.workOutWinnings(dices2));
        assertEquals(10,oBet.workOutWinnings(dices3));
